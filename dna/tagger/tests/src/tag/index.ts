...
const taggerDna = path.join(__dirname, '../../../../tagger.dna')
...
const tagData1 = { organisationUuid: 'ae7d3dee-d310-44ba-ba12-5d48a08cc85a', uuid: uuidv4(), tagText: 'A Tag 1', color: '#963147', parent: 'Tags' }
const tagData2 = { organisationUuid: 'ae7d3dee-d310-44ba-ba12-5d48a08cc85a', uuid: uuidv4(), tagText: 'A Tag 2', color: '#963147', parent: 'Tags' }

module.exports = (orchestrator) => {
  orchestrator.registerScenario.only('Create a tag', async (s, t) => {
