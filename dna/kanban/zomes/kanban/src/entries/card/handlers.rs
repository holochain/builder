...
pub(crate) fn create_card(card_entry: CardEntry) -> KanbanResult<Card> {
...
pub(crate) fn delete_card(card: Card) -> KanbanResult<()> {
...
pub(crate) fn list_cards(input: CardListInput) -> KanbanResult<CardList> {
